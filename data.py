...
class Data:
    def __init__(self, filepath=None, headers=None, data=None, header2col=None) -> None:
    ...
    def parse_headers(self, lines:list[str]) -> None:
        ...
        self.header2col = {first_line[index]:index for index in type_dictionary}
        # Setting up the header list
        self.headers = [key for key in self.header2col]
        # Setting the number of columns
        self.num_cols = len(self.headers)
        

    def parse_data(self, fh) -> None:
        ...
        while(line):
            ...
            if line != "\n":
                ...
                numeric_elements = [elements[i] for i in list(self.header2col.values())]
    ...
    def get_header_indices(self, headers):
        ...
        return [self.headers[header] for header in headers]
